...
$(function() {
    ...
    function refreshCart(cart) {
      ...
      if (cart.item_count == 0) {
        ...
        if(total_savings > 0 ) {
          cart_savings_html = '<span class="thumbnail_banner violator--discount right margin-top-sm margin-bottom-lg">' + 'You save &nbsp;' + Shopify.formatMoney(total_savings - discounted_price_total, $('body').data('money-format')) + '</span>';
        } else {
          cart_savings_html = "";
        }
      }
