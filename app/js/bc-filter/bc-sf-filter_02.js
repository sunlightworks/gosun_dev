...
var bcSfFilterTemplate = {
    ...
    // Grid Template
    'productGridItemHtml': '<div class="{{itemColumnNumberClass}} {{itemCollectionGroupThumbClass}} {{itemCollectionGroupSmallClass}}" itemprop="itemListElement" itemscope itemtype="http://schema.org/Product"">' +
                               '<article class="article-tile article-tile--lg" >' +
                                    '<a href="{{itemUrl}}" itemprop="url">' +
                                            '<div class="article-media article-media--lg lazyload" style="background-image: url({{product.featured_image}})" title="{{ alt_text | escape }} ">' +
                                            '</div' +
                                            '<div class="article-tile-content article-tile-content--lg">' +
                                                '{{itemProductInfo}}' +
                                            '</div>' +
                                        '</a>' +
                                '</article>' +
